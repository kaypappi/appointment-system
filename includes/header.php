...
<!--                <a class="navbar-brand" href="#">Brand</a>-->
            ...
            <div  class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li class="active"><a href="../supervisor/supervisor_dashboard.php">HOME</a></li>
                    <?php
                        if($superLogInName){
                            echo "<li class='alert-danger'><a href='../html/student/logout.html.php'>Log-out: .$superLogInName. </a></li>";
                        }
                        elseif($studentLogInName){
                            echo "<li class='alert-danger'><a href='../logout.php'>Log-out: .$studentLogInName. </a></li>";
                        }
                        else{
